  ...
  return (
    <div className={styles.container}>
      ...
      <div>
        ...
        <a href="https://nomadlocals.netlify.app/activities">
          <h5 className={styles.aa}>Produccion</h5>
        </a>
        <a href="https://github.com/WilsonSanFullStack/AppDeEncuentos">
          <h5 className={styles.aa}>Codigo</h5>
        </a>
        ...
        <p className={styles.p}>
          <strong className={styles.strong}>
            Del 27 de Junio Al 31 de Agosto 2023
          </strong>
        </p>
        ...
        <div className={styles.section}>
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                <a href="https://www.linkedin.com/in/daniel-gomez-fullstack">
                  Linkedin
                </a>
              </li>
            </ul>
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                <a href="https://www.linkedin.com/in/david-felipe-florido-jim%C3%A9nez-a862bb262/">
                  Linkedin
                </a>
              </li>
            </ul>
      ...
      <div>
        ...
        <a href="https://github.com/WilsonSanFullStack/PiCountries">
          <h5 className={styles.aa}>Codigo</h5>
        </a>
        ...
        <p className={styles.p}>
          <strong className={styles.strong}>Control de versionado:</strong>{" "}
        ...
        <p className={styles.p}>
          <strong className={styles.strong}>Front:</strong> JavaScript,
          react.js, redux.js.
        </p>
        <p className={styles.p}>
          <strong className={styles.strong}>Back:</strong> Node.js, express,
      ...
      <div>
        ...
        <a href="https://github.com/WilsonSanFullStack/ft-38a/tree/main/ryckandmorty">
          <h5 className={styles.aa}>Codigo</h5>
        </a>
        <h5 className={styles.h5}>HENRY</h5>
        <p className={styles.p}>
        ...
        <p className={styles.p}>
          <strong className={styles.strong}>Front:</strong> JavaScript, react.js
          y redux.js.
        </p>
        <p className={styles.p}>
        ...
        <p className={styles.p}>
          <strong className={styles.strong}>Base de datos:</strong> PostgreSQL y
          Sequelize.
        </p>
        <p className={styles.p}>
          <strong className={styles.strong}>
